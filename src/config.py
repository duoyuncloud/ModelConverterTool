...
def resolve_final_config(preset_name: Optional[str], config_file: Optional[str], cli_overrides: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for category, model_list in presets.items():
        ...
        for model_name in model_list:
            ...
            if preset:
                ...
                print(f"    Supported Formats: {', '.join(preset.get('supported_formats', []))}")
