...
class TensorNameMap:
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.FFN_EXP_PROBS_B: ("model.layers.{bid}.mlp.gate.e_score_correction",),  # deepseek-v3 dots1
        # Feed-forward up
        MODEL_TENSOR.FFN_UP: (
        ...
        MODEL_TENSOR.PER_LAYER_MODEL_PROJ: ("model.per_layer_model_projection",),  # gemma3n
        MODEL_TENSOR.PER_LAYER_PROJ_NORM: ("model.per_layer_projection_norm",),  # gemma3n
        ...
        MODEL_TENSOR.LAUREL_POST_NORM: ("model.layers.{bid}.laurel.post_laurel_norm",),  # gemma3n
        MODEL_TENSOR.SSM_IN: (
        ...
        MODEL_TENSOR.SSM_DT_NORM: ("model.layers.{bid}.mamba.dt_layernorm",),  # jamba
        MODEL_TENSOR.SSM_A: (
        ...
        MODEL_TENSOR.V_MMPROJ_FC: ("model.connector.modality_projection.proj",),  # SmolVLM
        ...
        MODEL_TENSOR.V_ENC_ATTN_Q_NORM: ("vision_tower.vision_model.encoder.layers.{bid}.attn.q_norm",),  # InternVL
        ...
        MODEL_TENSOR.V_ENC_ATTN_K_NORM: ("vision_tower.vision_model.encoder.layers.{bid}.attn.k_norm",),  # InternVL
        ...
        MODEL_TENSOR.V_LAYER_SCALE_1: ("vision_tower.vision_model.encoder.layers.{bid}.ls1",),  # InternVL
        MODEL_TENSOR.V_LAYER_SCALE_2: ("vision_tower.vision_model.encoder.layers.{bid}.ls2",),  # InternVL
        ...
        MODEL_TENSOR.V_MM_PATCH_MERGER: ("multi_modal_projector.patch_merger.merging_layer",),  # mistral small 3.1
        # audio (mtmd)
        ...
        MODEL_TENSOR.A_MMPROJ: ("audio.multi_modal_projector.linear_{bid}",),  # ultravox
