"""
Parameter setting helpers for Megatron<->HF conversion loaders in ModelConverterTool.
These functions are used by Llama and MiniCPM loader scripts for weight assignment and mapping.
"""
