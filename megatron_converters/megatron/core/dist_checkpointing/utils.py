...
def extract_sharded_tensors_and_factories(
    ...
    """
    return extract_matching_values(sharded_state_dict, lambda v: isinstance(v, (ShardedTensor, ShardedTensorFactory)))
...
def extract_nonpersistent(
    ...
    return extract_matching_values(
        sharded_state_dict,
        lambda v: isinstance(v, LocalNonpersitentObject),
    )
