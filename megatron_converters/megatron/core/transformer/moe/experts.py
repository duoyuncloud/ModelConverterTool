...
class GroupedMLP(MegatronModule):
    ...
    def sharded_state_dict(self, prefix="", sharded_offsets=(), metadata=None):
        raise NotImplementedError("Currently distributed checkpointing is not supported for GroupedMLP")
...
class SequentialMLP(MegatronModule):
    ...
    def sharded_state_dict(self, prefix="", sharded_offsets=(), metadata=None):
        ...
        if self.moe_extended_tp:
            raise NotImplementedError("Currently distributed checkpointing is not supported for moe_extended_tp")
        ...
        for expert_local_idx, expert in enumerate(self.local_experts):
            ...
            expert_state_dict = expert.sharded_state_dict(expert_state_dict_prefix, expert_sharded_offsets, metadata)
            # Remove expert layers indexing from sharded keys
            replace_prefix_for_sharding(expert_state_dict, expert_state_dict_prefix, expert_sharded_prefix)
