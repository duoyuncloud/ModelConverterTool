...
class Router(ABC, MegatronModule):
    ...
    def __init__(self, config: TransformerConfig) -> None:
        ...
        self.weight = torch.nn.Parameter(torch.empty((self.config.num_moe_experts, self.config.hidden_size)))
...
class TopKRouter(Router):
    ...
    def apply_z_loss(self, logits):
        ...
        if self.config.moe_z_loss_coeff is not None:
            moe_z_loss_coeff = self.config.moe_z_loss_coeff / parallel_state.get_tensor_model_parallel_world_size()
