...
def make_sharded_tensors_for_checkpoint(
    ...
    for layer_name in state_dict.keys():
        ...
        if layer_name.endswith(extra_state_suffix):
            sharded_state_dict[layer_key] = make_sharded_object_for_checkpoint(tensor, layer_key, sharded_offsets)
...
def sharded_state_dict_default(
    ...
    if hasattr(module, "sharded_state_dict"):
        module_sharded_sd = module.sharded_state_dict(prefix=prefix, sharded_offsets=sharded_offsets, metadata=metadata)
    else:
