    ...
    def __getitem__(self, sample_idx: int) -> dict:
        ...
        for chunk_idx in chunk_idxs:
            ...
            with h5py.File(neighbor_path, "r") as f:
                neighbor_chunk_ids = f["neighbors"][chunk_idx % self.block_size, : self.num_neighbors].tolist()
...
def get_retro_datasets(
    ...
    for data_key, chunk_ds_info in chunk_ds_info_map.items():
        ...
        neighbor_path_map = BlockPathMap.from_dir(dir=neighbor_dir, block_size=config.retro_block_size)
