...
def _initialize_affine_weight_gpu(weight, init_method, partition_dim, stride=1, expert_parallel=False):
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.explicit_expert_comm = self.is_expert and (config.sequence_parallel or self.expert_parallel)
