...
class MultiModalDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, name, data_prefix, indexed_dataset, num_samples, seq_length, seed, img_h, img_w):
    ...
    def __getitem__(self, idx):
        ...
        return {"text": np.array(text_sample, dtype=np.int64), "img": np.array(img_sample, dtype=np.float32)}
