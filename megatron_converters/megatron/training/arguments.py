...
def _add_network_size_args(parser):
    ...
    group.add_argument('--query-rope-channels', type=int, default=None,
                       help='query_rope_dim in MLA')
    group.add_argument('--query-nope-channels', type=int, default=None,
                       help='query_nope_dim in MLA')
    group.add_argument('--query-lora-hidden-size', type=int, default=None,
                       help='query_lora hidden size in MLA')
    group.add_argument('--kv-lora-hidden-size', type=int, default=None,
                       help='kv_lora hidden size in MLA')
    ...
    group.add_argument('--rotary-base', type=float, default=10000,
                       help='base of rotary position embedding')
    group.add_argument('--use-longrope', action='store_true',
                        help='whether use longrope')
    group.add_argument('--longrope-short-factor', nargs="*", default=None, type=float,
                        help='short factor used in longrope')
    ...
    group.add_argument('--use-mla', action='store_true',
...
def _add_training_args(parser):
    ...
    group.add_argument('--log-task-loss-interval', type=int, default=100,
...
def _add_learning_rate_args(parser):
    ...
    group.add_argument('--wsd-drop-rate', type=float, default=0.5,
                       help='drop rate for warmup-stable-exponential, '
                       'exp: lr * (exp_drop_rate ** ((num_step - (train_steps - decay_steps) / drop_cycle_steps)))')
    group.add_argument('--wsd-drop-cycle-iters', type=float, default=0.3,
                       ...
                       'exp: lr * (exp_drop_rate ** ((num_step - (train_steps - decay_steps) / drop_cycle_steps)))')
    group.add_argument('--wsd-drop-cycle-samples', type=float, default=0.3,
...
def _add_checkpointing_args(parser):
    ...
    group.add_argument('--merge-mode', type=str, default='megatron_to_pt',
                       choices=['megatron_to_pt', 'pt_to_hf'])
    return parser
...
def _add_data_args(parser):
    ...
    group.add_argument('--clear_sampler_state', action='store_true', help='whether clear the max error state of megatron data sampler')
    ...
    group.add_argument('--custom-tokenizer-eod', type=int, default=None,
                       help='custom tokenizer eod.')    
    group.add_argument('--reset-position-ids', action='store_true',
                       help='Reset posistion ids after end-of-document token.')
    group.add_argument('--reset-attention-mask', action='store_true',
                       help='Reset self attention maske after '
                       'end-of-document token.')
    group.add_argument('--use-packed-seq', action='store_true', 
    ...
    group.add_argument('--item-builder-type', type=str, default='llama3_chat',
                       choices=['qwen2_chat', 'llama3_chat', 'minicpm3_chat'],
                       help='pretraining objectives')
    group.add_argument('--skip-overlength', action='store_true', default=False,
                       help="is skip over length data")
    group.add_argument('--skip-no-image', action='store_true', default=False,
                       help="is skip no image data")
    group.add_argument('--img-aug', action='store_true', default=False,
                       help="use image aug")
    group.add_argument('--min-resolution', default=10, type=int,
                       help='min resolution to filter out images')
    ...
    group.add_argument('--use-image-id', action='store_true', default=False,
    ...
    group.add_argument('--total-max-length', default=4096, type=int,
                       help='total max length of input')
...
def _add_vision_args(parser):
    ...
    group.add_argument('--vit-num-layers', type=int, default=None,
                       help='Number of ViT transformer layers.')
    group.add_argument('--vit-hidden-size', type=int, default=None,
                       help='ViT Tansformer hidden size.')
    group.add_argument('--vit-ffn-hidden-size', type=int, default=None,
                       help='ViT Transformer Feed-Forward Network hidden size. '
                       'This is set to 4*hidden-size if not provided')
    group.add_argument('--vit-num-attention-heads', type=int, default=None,
                       help='Number of transformer attention heads.')
    group.add_argument('--vit-normalization', default='LayerNorm',
                       choices=['LayerNorm', 'RMSNorm'],
                       help='Which normalization technique to use.')
    group.add_argument('--vit-norm-epsilon', type=float, default=1e-6,
                       help='Epsilon for ViT layer norm and RMS norm.')
    group.add_argument('--vit-disable-bias-linear', action='store_false',
                       help='Disable bias in the linear layers',
                       dest='vit_add_bias_linear')
    group.add_argument('--vit-add-qkv-bias', action='store_true',
                       help='Enable bias only in the QKV linear layers')
    group.add_argument('--vision-encoder', type=str, default='clip')
    group.add_argument('--drop-vision-last-layer', action='store_true',
                       help='is drop last layer')
    group.add_argument('--img-size', default=224, type=int,
                       help='images input size for vision encoder')
    ...
    group.add_argument('--query-num', default=64, type=int,
                       help='query numbers')
