...
def validate_args(args, defaults={}):
    ...
    if args.use_tp_pp_dp_mapping:
        assert (
            args.context_parallel_size * args.expert_model_parallel_size <= 1
...
def _add_straggler_detector_args(parser):
    ...
    group.add_argument("--log-straggler", action="store_true", help="If set, tracks and logs straggler per GPU.")
    group.add_argument(
        "--disable-straggler-on-startup", action="store_true", help="If set, StragglerDetector is disabled on startup."
    )
    group.add_argument(
...
def _add_mixed_precision_args(parser):
    ...
    group.add_argument(
        "--attention-softmax-in-fp32", action="store_true", help="Run attention masking and softmax in fp32."
    )
    group.add_argument(
...
def _add_distributed_args(parser):
    ...
    group.add_argument("--ddp-bucket-size", type=int, default=None, help="Bucket size for data-parallel communication")
    group.add_argument(
