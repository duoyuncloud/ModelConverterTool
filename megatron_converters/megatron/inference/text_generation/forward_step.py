...
class ForwardStep:
    ...
    def __call__(self, tokens, position_ids, attention_mask):
        ...
        if self.pipeline_size_larger_than_one:
            ...
            if current_batch_x_seqlen >= self.pipelining_batch_x_seqlen:
                ...
                return self._with_pipelining_forward_step(tokens, position_ids, attention_mask, micro_batch_size)

        return self._no_pipelining_forward_step(tokens, position_ids, attention_mask)
    ...
    def _no_pipelining_forward_step(self, tokens, position_ids, attention_mask, recv_buffer=None):
