"""
Llama-2 Megatron<->HF conversion loader for ModelConverterTool.
This script provides the core logic for converting Llama-2 model weights between Megatron and HuggingFace formats.
...
def add_arguments(parser):
    ...
    parser.add_argument(
        "--checkpoint-type", type=str, required=True, help='Type of checkpoint to convert, options are "meta" or "hf"'
    )
